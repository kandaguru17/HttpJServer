...
class HttpVersionTest {
    ...
    void getCompatibleHttpVersion_returnCorrectHttpVersion(String versionLiteral) throws HttpParsingException {
    ...
    @Test
    void getCompatibleHttpVersion_returnNull() throws HttpParsingException {
